...
def test_encode_and_decode_strings1() -> None:
    solution = Solution()
    list1 = ["neet", "code", "love", "you"]
    list2 = ["we", "say", ":", "yes"]
    list3 = ["we", "say", ":", "yes", "!@#$%^&*()"]
    ...
    assert solution.decode1(solution.encode(list1)) == list1
    assert solution.decode1(solution.encode(list2)) == list2
    assert solution.decode1(solution.encode(list3)) == list3
    assert solution.decode1(solution.encode(list4)) == list4
    assert solution.decode1(solution.encode(list5)) == list5
    assert solution.decode1(solution.encode(list6)) == list6
    assert solution.decode1(solution.encode(list7)) == list7
